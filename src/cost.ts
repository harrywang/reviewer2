...
export const COST_PER_1M: PricingTable = {
  ...
  "openai/gpt-5.6-sol": { prompt: 5.0, completion: 30.0 },
  "openai/gpt-5.6-terra": { prompt: 2.5, completion: 15.0 },
  "openai/gpt-5.6-luna": { prompt: 1.0, completion: 6.0 },
  "openai/gpt-5.6": { prompt: 5.0, completion: 30.0 },
